...
const Carriculum = () => {
    ...
    return (
        <div className='pb-[88px] wrapper'>
                    ...
                    <h3 className='text-[32px] font-poppins font-semibold leading-[56px] text-center text-[#231F40] mt-[5px]'>Our Comprehensive curriculum, Designed for professionals</h3>
                <div className='flex gap-[75px] mt-12'>
...
accumsan lacus vel facilisis.</p>
                    ...
                    <div className='font-inter bg-white shadow-[0px_10px_30px_rgba(0,0,0,0.7)] px-5 pb-[54px] pt-[63px] rounded-[8px] min-w-[360px] border-b-[4px] border-[#1B99D4]'>
