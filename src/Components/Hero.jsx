...
const Hero = () => {
    return (
        <div className='bg-[#1B99D4] wrapper min-[768px]:flex justify-between items-center relative pt-5 pb-5 sm:pb-0 sm:pt-16 md:pt-[100px]'>
            <div className='font-roboto text-white flex flex-col justify-start items-start gap-5 max-w-[455px]'>
                ...
                <h1 className='font-bold text-[28px] sm:text-[32px] md:text-[42px] text-center sm:text-left leading-[32.5px] sm:leading-[35.5px] md:leading-[47.5px]'>Advanced Data Science 
                & AI Course</h1>
                <p className='text-[15px] sm:text-[17px] leading-6 font-normal'>Equip yourself with data science skills through live, interactive lectures guided by industry expert mentors</p>
                <h4 className='text-[22px] sm:text-2xl md:text-[28px] leading-6 font-normal'>Live  Interactive Classes</h4>
            ...
            <div className='bg-white rounded-[10px] mt-5 mb-5 sm:mt-[50px] sm:mb-[45px]'>
