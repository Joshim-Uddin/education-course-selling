...
const Hero = () => {
    return (
        <div className='bg-[#1B99D4] wrapper flex justify-between items-center'>
            <div className='font-roboto text-white flex flex-col justify-center gap-5'>
            ...
            <div className='bg-white rounded-[10px]'>
                <form action="">
                    <h3 className='text-4xl leading-[33.6px] font-bold font-roboto'>We're here to help!</h3>
                    ...
                    <button className='bluebtn flex items-center gap-[15px] font-roboto'>Get in Touch <FaArrowRight /></button>
                    </div>
                </form>
            </div>
        </div>
