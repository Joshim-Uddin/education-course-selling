...
const Projects = () => {
    return (
        <div className='wrapper md:overflow-hidden pb-9 md:pb-[122px]'>
            <div className='flex flex-col lg:flex-row items-center gap-[71.5px] md:gap-[131.5px]'>
                ...
                <div className='relative'>
                    <div className='font-roboto flex flex-col items-start gap-[22px] md:max-w-[630px] bg-white pt-3 md:pt-11 ps-3 md:ps-10 pb-2 md:pb-9 pr-4 md:pr-[150px] shadow-[1px_5px_50px_0_#54637A] rounded-[10px] mb-3 sm:mb-3'>
                    ...
                    <div className='font-roboto flex flex-col items-start gap-[22px] max-w-[630px] bg-white pt-3 md:pt-11 ps-3 md:ps-10 pb-3 md:pb-9 shadow-[1px_5px_50px_0_#54637A] rounded-[10px] lg:absolute -right-[539px] top-0'>
                        <h5 className='font-bold text-[22px] leading-[100%] text-center text-[#727695]'>Authentication</h5>
                        <img src="https://res.cloudinary.com/dfxk2ofkn/image/upload/v1746366696/symantec_cobfxf.png" alt="" />
                        <p className='leading-[23px] text-[#646464] max-w-[440px]'>Create authentication technology to give access, Correspond to those stored in a database of authorized users.</p>
                        <div className='flex items-center justify-center gap-5'>
            ...
            <div className='mt-8 md:mt-[122px] flex flex-col lg:flex-row min-[1860px]:justify-around gap-[55px]'>
                ...
                <div className='font-roboto pt-4 md:pt-[54px]  pb-4 md:pb-[51px] ps-4 xl:ps-[39px] pr-4 xl:pr-[38px] border-[1px] rounded-[8px] border-[#D9D9D9]'>
                    ...
                    <div className='flex flex-col md:flex-row items-end justify-between xl:min-w-[851px]'>
                        <div>
            ...
            <div className='cohort font-roboto mx-3 md:mx-[42px] lg:[120px] xl:mx-[268px] mt-10 md:mt-[83px]'>
