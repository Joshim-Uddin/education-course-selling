...
const Faq = () => {
    ...
    return (
        <div className='wrapper'>
            ...
            <h3 className='text-3xl md:text-[40px] font-poppins font-semibold md:leading-[56px] text-center text-[#231F40] mt-[5px] max-w-[922px] mx-auto'>Frequently Asked Questions</h3>
            <Accordion className='mt-[65px] mb-[84px] md:px-[118px] flex flex-col gap-[35px] text-xl'>
                {
